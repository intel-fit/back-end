...
public class MealService {
    ...
    private final UserFoodPreferenceService preferenceService; // 기존
    private final DailyProgressService dailyProgressService;   // ✅ 추가 (칼로리 반영용)
    ...
    public MealDto.MealCreateResponse createMeal(
        ...
        // ✅ DailyProgress 칼로리 갱신만 수행
        dailyProgressService.updateCalorieOnly(user, request.getMealDate());
