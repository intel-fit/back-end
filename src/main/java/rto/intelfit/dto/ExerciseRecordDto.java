...
public class ExerciseRecordDto {
    ...
    public static class Response {
        ...
        // ✅ Entity → DTO 변환
        public static Response from(ExerciseRecordDB e) {
    ...
    public static class ListResponse {
        ...
        public static ListResponse from(User user, List<ExerciseRecordDB> list) {
    ...
    public static class WgerResponse {
        ...
        @Schema(description = "운동 부위 id", example = "10")
